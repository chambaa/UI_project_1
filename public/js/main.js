...
function mockAddToCart() {
  ...
  drawDot({x:itemToRemove.x, y: itemToRemove.y});
}
...
function drawLine(startX, startY, endX, endY)
{
  ...
  routeCtx.strokeStyle = '#5F021F';
  routeCtx.stroke();
}

function drawItem(x, y)
{
  routeCtx.fillStyle = "#0E426C";
